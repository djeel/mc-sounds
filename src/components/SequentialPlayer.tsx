...
const SequentialPlayer: React.FC<SequentialPlayerProps> = ({
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 animate-fade-in">
      <div className="minecraft-button bg-modrinth-green-500 border-modrinth-green-600 p-4 min-w-[250px] shadow-lg">
        <div className="flex items-center justify-between gap-3">
          <div className="flex-1 min-w-0">
            <p className="text-xs text-white/80 mb-1">Playing Category</p>
          ...
          <button
            onClick={onStop}
            className="minecraft-button p-2 bg-white text-modrinth-green-500 border-white hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white"
